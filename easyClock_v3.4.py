# Fixed normalization of oscillation_power between groups in CWT.
# Optimzed plot fontsize.
...
# plot_harmonic_cosinor_fitting_model within visualization functionality.
    ...
    def plot_cwt(self, dtype=None, groups_to_plot=None, time_range=None):
        ...
        for group in groups_to_plot:
            ...
            cbar.set_label("Power", fontsize=24, labelpad=-20)
            cbar.set_ticks([1])
            ...
            ax.legend(loc="upper right", fontsize=24, framealpha=0.3)
            ax.grid(False)
            plt.tight_layout()
            plt.show()
