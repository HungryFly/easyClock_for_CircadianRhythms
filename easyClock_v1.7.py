# adjust the acrophase calculation in Harmonic cosinor.
...
def fit_group_harmonic_cosinor(df, period_range=[20,20.5,21,21.5,22,22.5,23,23.5,24,24.5,25,25.5,26,26.5,27,27.5,28],
    ...
    acrophase_h = acrophase_to_hours(-2 * np.pi * best_lag / best_per, best_per)
            #### using corrected lag when tau < 0 because of Kendall's tau method.
    corrected_lag = (acrophase_h - best_per / 2) % best_per if best_tau < 0 else acrophase_h
