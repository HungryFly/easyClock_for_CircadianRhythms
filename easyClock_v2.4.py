# add Benjamini–Hochberg FDR (BH.Q) for large data comparisons, like transcriptome.
# add progress bar in Python-JTK analysis. 
# fix p-value correction in Cosinor analysis.
...
class CircadianApp(QtWidgets.QMainWindow):
    ...
    def load_data(self):
        ...
        progress = QProgressDialog("Preparing Groups: 500 groups/min...", "", 0, 0, self)
