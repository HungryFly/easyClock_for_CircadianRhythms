# implement AR-JTK for hanlding potential autoregressive (AR) noise.
# implement Continuous Wavelet Transform (CWT) for non-stationary rhythms.
# implement individual rhythm analysis.
# implement linear mixed-effect model (LME).
