# optimize span color setting.
# add shaded span removing functionality.
# fix ghost images (or figure residual).
# fix the analysis result layout alignment.
# replace "Behavior" with "File" in application for general use.
